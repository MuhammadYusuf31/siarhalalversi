...
export default function Items() {
    ...
    if (resp.length!=0){
        arButton.push(
            <Link href={"https://hadziq.8thwall.app/belajarnavigasi/" + dLat + "&destlon=" + dLon + "&mode=" + mode} type="button" className=" text-center mt-8 relative w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-8 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Mulai navigasi</Link>
